            ...
            <div class="cs-panel-body">
                ...
                <div style="margin-top:22px;border-top:1px solid #e8edf5;padding-top:20px;">
                    ...
                    <div style="margin-top:22px;border-top:1px solid #e8edf5;padding-top:20px;">
                        ...
                        <div id="cs-bf-geo-map" style="height:320px;border-radius:6px;overflow:hidden;border:1px solid #e2e8f0;background:#e8f4f4;margin-top:8px;"></div>
